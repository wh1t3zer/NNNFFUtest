...
//                templateMessage.addData(new WxMpTemplateData("first", "你有一条综测材料被驳回", "black"));
//                templateMessage.addData(new WxMpTemplateData("keyword1", reason, "#FF00FF"));
//                templateMessage.addData(new WxMpTemplateData("keyword2", dateFormat.format(date), "black"));
//                templateMessage.addData(new WxMpTemplateData("remark", "点击此卡片进入综测系统", "black"));
//        try {
