...
create table sys_dept (
  dept_id           bigint(20)      not null auto_increment    comment '院系id',
  parent_id         bigint(20)      default 0                  comment '父部门id（学校）',
  ancestors         varchar(50)     default ''                 comment '祖级列表',
  dept_name         varchar(30)     default ''                 comment '院系名称',
  order_num         int(4)          default 0                  comment '显示顺序',
  leader            varchar(20)     default null               comment '负责人',
  phone             varchar(11)     default null               comment '联系电话',
  email             varchar(50)     default null               comment '邮箱',
  status            char(1)         default '0'                comment '院系状态（0正常 1停用）',
...
create table sys_user (
  ...
  major             char(30)        default null               comment '专业名称',
  user_name         varchar(30)     not null                   comment '用户账号',
  nick_name         varchar(30)     not null                   comment '用户姓名',
  classname         char(30)        default null               comment '班级',    
...
-- 初始化-职位信息表数据
-- ----------------------------
insert into sys_post values(1, 'leader',  '系主任',    1, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(2, 'instructor',   '辅导员',  2, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(3, 'monitor',   '班长',  3, '0', 'admin', sysdate(), '', null, '');
...
create table sys_role (
  ...
  data_scope           char(1)         default '1'                comment '数据范围（1：全部数据权限 2：自定数据权限 3：本院系数据权限 4：本院系及以下数据权限）',
...
insert into sys_menu values('103',  '部门管理', '1',   '4', 'dept',       'system/dept/index',        '', 1, 0, 'C', '0', '0', 'system:dept:list',        'tree',          'admin', sysdate(), '', null, '院系管理菜单');
...
-- 院系管理按钮
insert into sys_menu values('1017', '院系查询', '103', '1',  '', '', '', 1, 0, 'F', '0', '0', 'system:dept:query',          '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1018', '院系新增', '103', '2',  '', '', '', 1, 0, 'F', '0', '0', 'system:dept:add',            '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1019', '院系修改', '103', '3',  '', '', '', 1, 0, 'F', '0', '0', 'system:dept:edit',           '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1020', '院系删除', '103', '4',  '', '', '', 1, 0, 'F', '0', '0', 'system:dept:remove',         '#', 'admin', sysdate(), '', null, '');
-- 职位管理按钮
insert into sys_menu values('1021', '职位查询', '104', '1',  '', '', '', 1, 0, 'F', '0', '0', 'system:post:query',          '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1022', '职位新增', '104', '2',  '', '', '', 1, 0, 'F', '0', '0', 'system:post:add',            '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1023', '职位修改', '104', '3',  '', '', '', 1, 0, 'F', '0', '0', 'system:post:edit',           '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1024', '职位删除', '104', '4',  '', '', '', 1, 0, 'F', '0', '0', 'system:post:remove',         '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1025', '职位导出', '104', '5',  '', '', '', 1, 0, 'F', '0', '0', 'system:post:export',         '#', 'admin', sysdate(), '', null, '');
-- 参数设置按钮
...
insert into sys_config values(2, '用户管理-账号初始密码',         'sys.user.initPassword',         '',        'Y', 'admin', sysdate(), '', null, '初始化密码 教务系统同' );
